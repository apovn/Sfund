...
import niteco.splus.service.PaymentService;
...
public class PaymentResourceIntTest {
    ...
    private static final PayStatusEnum DEFAULT_STATUS = PayStatusEnum.PAID;
    private static final PayStatusEnum UPDATED_STATUS = PayStatusEnum.UNPAID;
