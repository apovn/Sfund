...
import { ReasonComponent } from 'app/entities/reason/reason.component';
import { ReasonService } from 'app/entities/reason/reason.service';
import { Reason } from 'app/shared/model/reason.model';

describe('Component Tests', () => {
    describe('Reason Management Component', () => {
        let comp: ReasonComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ReasonComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.reasons[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
